        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
              ...
              that contains a banner image with a{" "}
              <span className="text-textGreen">call-to-action</span> button that
              invites the user to start the rental process. Below the banner,
              there are various sections that provide additional information
              about the car rental service, such as the available car models,
