    ...
    <div className="bg-textDark">
      <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-start justify-between text-white md:px-8">
        <div className="flex gap-x-4">
          <div className="w-10 h-10 flex-none rounded-lg bg-textDark flex items-center justify-center">
            <svg
              className="w-6 h-6"
          ...
          <p className="py-2 font-medium">
            ...
            <a className="font-semibold underline duration-150 hover:text-indigo-100">
              Thank you for your patience and understanding as I continue to
              update it.
            </a>
          </p>
        </div>
